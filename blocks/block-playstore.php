...
function emuzone_playstore_template( string $url ) {
	...
	<div class="row justify-content-center">
		<a target="_blank" rel="noopener" href="<?php echo esc_url( $url ); ?>"><img src="<?php echo get_theme_file_uri( 'assets/google-play-badge.png' ); ?>" alt="Google Play Store button" width="180" height="70" class="d-block mx-auto"></a>
